<template>
  <svg :width="currentSize.width" :height="currentSize.height" :viewBox="box" class="gf-icon">
    ...
    watch: {
      async name(val) {
        ...
        this.xml = await import(
          /* webpackMode: 'lazy-once', webpackChunkName: 'icon-svg' */ '@/assets/svgs/' + this.name + '.svg'
          )
      }
    },
    async created() {
